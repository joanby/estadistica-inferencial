---
title: "Taller de probelmas resueltos inferencia"
...
Los datos están en https://raw.githubusercontent.com/joanby/estadistica-inferencial/master/datasets/, en dos 
...
```{r cargadatosoculta}
G1=read.csv("https://raw.githubusercontent.com/joanby/estadistica-inferencial/master/datasets/grado1.txt",header=TRUE)$x
G2=read.csv("https://raw.githubusercontent.com/joanby/estadistica-inferencial/master/datasets/grado2.txt",header=TRUE)$x
...
* el primero es $frequency = b_0+b_1\cdot degree$ que es el modelo LINEAL que resuelve la fución `lm`.
