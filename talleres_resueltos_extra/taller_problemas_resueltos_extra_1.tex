...
\hypersetup{
  pdftitle={Taller de probelmas resueltos inferencia},
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{G1=}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/joanby/estadistica{-}inferencial/master/datasets/grado1.txt"}\NormalTok{,}\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{)}\OperatorTok{$}\NormalTok{x}
\NormalTok{G2=}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/joanby/estadistica{-}inferencial/master/datasets/grado2.txt"}\NormalTok{,}\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{)}\OperatorTok{$}\NormalTok{x}
