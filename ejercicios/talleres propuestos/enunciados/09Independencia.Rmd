...
1. Nos dan las notas de cierta asignatura de 3 grupos de alumnos $A$, $B$ y $C$:
\ \newline
\begin{center}
...
1. En un estudio del 2003 se investigó si el historial familiar del paciente con desorden bipolar tiene influencia
