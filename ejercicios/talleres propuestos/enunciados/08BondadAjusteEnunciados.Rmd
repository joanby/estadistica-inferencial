...
En la tabla siguiente se muestran las sumas que se obtuvieron. Provar la hipótesis de que los dados no estaban
...
\end{tabular}
\end{center}
1. El $1972$, el informe oficial dió la información siguiente sobre el número
...
1. Se realizó una prueba de inteligencia a $100$ estudiantes. En la tabla siguiente se muestran las calificaciones
obtenidas:
\begin{center}
\begin{tabular}{|c|c|}
\hline
...
1. Consideremos la muestra aleatoria siguiente de una variable aleatoria $X$ tal que $X(\Omega)=[0,1]$.
...
\begin{tabular}{cccccccccc}
 ...
 \end{tabular}
 \end{center}
 1. Sea $X$ la variable aleatòria que tiene
