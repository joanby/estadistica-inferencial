...
En los siguientes problemas  resolver los que se pida explícitamente o si solo hay un enunciado resolver el problema con el contraste de hipótesis más apropiado. Calcular el $p$-valor de los contrastes.
