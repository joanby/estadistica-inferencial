...
En este caso la podemos reproducir de forma sencilla con funciones básicas de R



```{r}
alpha=1-0.95
IC=c(p_muestral-qnorm(1-alpha/2)*sqrt(p_muestral*(1-p_muestral)/n),p_muestral+qnorm(1-alpha/2)*sqrt(p_muestral*(1-p_muestral)/n))
IC
```
