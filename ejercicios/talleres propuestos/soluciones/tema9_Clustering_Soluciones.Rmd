...
Mirando la tabla anterior, podemos clasificar correctamente `r 6+5+1+2` jugadores de los 25 clasificando correctamente el `r 100*(6+5+1+2)/25`% de los jugadores de la muestra.
