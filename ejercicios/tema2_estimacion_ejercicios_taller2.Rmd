...
## Ejercicio 10
Un vendedor de coches piensa que el número de ventas 
...
## Ejercicio 11.
Supongamos  que los años de vida de los hombres de los  Estados Unidos Mexicanos
están   distribuidos  normalmente con media  $\mu$  y  varianza $\sigma^2$. Una muestra
aleatoria de $n=10000$ antecedentes de mortalidad de hombres en México se obtuvo como  resultado $\overline{x}=72.1$ hombres, $s^2 =144$ años.
...
## Ejercicio 13
Sea $X$ una variable aleatoria $N(\mu,\sigma)$ con $\sigma$ conocida y  $X_1,\ldots, X_n$
...
\frac{X_i}{n}\Biggr)}^2,\\  T_2 & = & \sum\limits_{i=1}^n \frac{X_i^2}{n}-\sigma^2.
\end{eqnarray*}
...
## Ejercicio 16
Consideremos una variable aleatoria $X$ que es $Exp(\lambda)$. 
...
## Ejercicio 18
Hallar los estimadores por método de los momentos y  por máxima verosimilitud del parámetro $\alpha$ de la distribución de Maxwell:
\[
...
## Ejercicio 19
Sea $X_1,\cdots,X_n$ una muestra aleatoria simple de una
...
Despejando $\lambda$   la ecuación

$\frac{\sum_{i=1}^n x_i}{\lambda}-n=0$ de obtiene $\lambda =\frac{\sum_{i=1}^n x_i}{n}=\overline{x}$.
