...
A continuación, vamos a estudiar los datos **binarios** y más adelante, los datos **continuos**, debido a que el significado de las **distancias** es distinto dependiendo del tipo de datos.
