...
Como dicha tabla de datos contiene muchos individuos, vamos a considerar sólo una muestra de 10 individuos:
```{r,message=FALSE,warning=FALSE}
library(car)
set.seed(2020)  # Fijamos la semilla
individuos.elegidos = sample(1:5226,10)
...
```
Vamos a hallar la matriz de **distancias de Hamming** entre los 10 individuos.
...
* `labels` es un vector de carácteres que permite poner nombres a los objetos; por defecto, se identifican en la representación gráfica por medio de sus números de fila en la matriz o el data frame que contiene los datos.
