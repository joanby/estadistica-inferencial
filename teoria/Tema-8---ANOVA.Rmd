...
* Todas estas poblaciones tienen la **misma varianza $\sigma^2$.**
...
## Ejemplo
<div class="example">
Para los datos del ejemplo que hemos estado trabajando, el contraste ANOVA en `R` se realizaría de la forma siguiente:
```{r}
...
* Todas las poblaciones, para todos los niveles, tienen la misma varianza $\sigma^2$.
...
## Ejemplo
<div class="example">
Para realizar el ANOVA de dos vías para los datos de nuestro ejemplo, hacemos lo siguiente:
```{r}
X=tabla.datos.GSI$GSI
A=tabla.datos.GSI$fotoperiodos
B=tabla.datos.GSI$temperatura
summary(aov(X ~ A*B))
```
