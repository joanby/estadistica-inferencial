...
```{r}
pares.ord[which(pares.ord[,5]<=0.05),] 
```
...
```{r,fig.align='center'}
interaction.plot(temperatura,fotoperiodos,GSI,xlab="fotoperíodo",ylab="GSI")
```
</div>
