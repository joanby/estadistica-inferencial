...
A continuación, de cara a profundizar en el análisis de la regresión, vamos a tratar los **aspectos inferenciales** de la regresión como el cálculo de **intervalos de confianza** y cómo realizar **contrastes de hipótesis** sobre los parámetros $\beta_0$ y $\beta_1$.
...
$$
Cov(\beta_0,\beta_1,\ldots,\beta_k)= \sigma_E^2\cdot (\mathbf{X}^\top\cdot \mathbf{X})^{-1},
$$
y un estimador no sesgado de la varianza común $\sigma_E^2$ es $S^2=\frac{SS_E}{n-k-1}$.
