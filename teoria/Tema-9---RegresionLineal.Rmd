...
* *Errores*: los errores tienen que seguir una $N(0,\sigma)$, cono la misma varianza, y ser incorrelados.
...
```{r}
residuos=r$res
(X0=length(residuos)*summary(lm(residuos^2~x+x^2))$r.squared)
...
## Test de White en `R`
Para usar el **Test de White** en `R`, tenemos que usar la función `white.test` del paquete `het.test`.
