...
El test necesita de una tabla de valores críticos para tomar la decisión final.  Concretamente, $d$ se tiene que comparar cono dos valoras críticos $d_{L,\alpha}$ y $d_{U,\alpha}$, donde  $\alpha$ es el nivel de significación que depende de $n$ y de $k$.
