...
## Contrastes de bondad de ajuste con parámetros poblacionales desconocidos
...
* $e_0 = n\cdot P(X_0\in \mbox{Clase }0)=n\cdot P(X_0 =0)=`r 229+ 211+ 93 +35 + 7 + 1`\cdot \frac{`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`^0}{0!}\mathrm{e}^{-`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`}=
 `r 229+ 211+ 93 +35 + 7 + 1`\cdot \mathrm{e}^{-`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`}=`r round((229+ 211+ 93 +35 + 7 + 1)*exp(-(211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1)),3)`.$
 
* $e_1 = n\cdot P(X_0\in \mbox{Clase }1)=n\cdot P(X_0 =1)=`r 229+ 211+ 93 +35 + 7 + 1`\cdot \frac{`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`^1}{1!}\mathrm{e}^{-`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`}=`r round((229+ 211+ 93 +35 + 7 + 1)*((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1))*exp(-(211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1)),3)`.$

* $e_2 = n\cdot P(X_0\in \mbox{Clase }2)=n\cdot P(X_0 =2)=`r 229+ 211+ 93 +35 + 7 + 1`\cdot \frac{`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`^2}{2!}\mathrm{e}^{-`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`}=`r round((229+ 211+ 93 +35 + 7 + 1)*((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1))^2*exp(-(211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1))/factorial(2),3)`.$

* $e_3 = n\cdot P(X_0\in \mbox{Clase }3)=n\cdot P(X_0 =3)=`r 229+ 211+ 93 +35 + 7 + 1`\cdot \frac{`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`^3}{3!}\mathrm{e}^{-`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`}=`r round((229+ 211+ 93 +35 + 7 + 1)*((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1))^3*exp(-(211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1))/factorial(3),3)`.$

* $e_4 = n\cdot P(X_0\in \mbox{Clase }4)=n\cdot P(X_0 =4)=`r 229+ 211+ 93 +35 + 7 + 1`\cdot \frac{`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`^4}{4!}\mathrm{e}^{-`r round((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1),3)`}=`r round((229+ 211+ 93 +35 + 7 + 1)*((211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1))^4*exp(-(211+93*2+35*3+7*4+1*5)/(229+ 211+ 93 +35 + 7 + 1))/factorial(4),3)`.$
</div>
...
& = `r n`-(`r round(e0,3)`+
`r round(e1,3)`+`r round(e2,3)`+`r round(e3,3)`+`r round(e4,3)`
)=`r round(n-(e0+e1+e2+e3+e4),3)`.
\end{array}
$$
</div>