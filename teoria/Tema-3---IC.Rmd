...
Hemos escogido al azar 50 estudiantes de grado de la UIB, hemos calculado sus notas medias de las asignaturas del primer semestre, y la media de estas medias ha sido $\overline{x}=6.3$, con una varianza muestral $\widetilde{s}^2=1.8.$
...
P(A<\theta<B)=1-\alpha.
$$
El valor $(1-\alpha)\cdot 100$% (y también  $1-\alpha$) recibe el nombre de **nivel de confianza**.
...
Sea $X$ una v.a. normal con media poblacional $\mu$ desconocida y desviación típica poblacional $\sigma$ conocida (en la práctica, usualmente, estimada en un experimento anterior)
...
* Es decir si, $n \geq 100$ y que $n\cdot \widehat{p}_{X}\geq 10$ (10 o más éxitos) y $n\cdot (1-\widehat{p}_{X})\geq 10$ (10 o más fracasos).
